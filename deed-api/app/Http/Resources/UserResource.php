...
class UserResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'bd_municipality_id'     => $this->bd_municipality_id,
            'bd_city_corporation_id' => $this->bd_city_corporation_id,
            'bd_post_office_id'      => $this->bd_post_office_id,
            'bd_ward'                => $this->bd_ward,
            'avatar'                 => $this->avatar,
